...
graf_pesquisas(pesquisas, "Var. % margem", titulo = "Termômetro do varejo, serviços e índustria: variação marginal (%)", caption = foot_ibge)
```

# PMC, PMS, PIM-PF: Variação interanual
...
# PMC, PMS, PIM-PF: Variação acumulada em 12 meses
